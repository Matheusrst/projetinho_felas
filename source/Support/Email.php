...
class Email
{
     ...
     * @return boll
     */
    public function queue(string $from = CONF_MAIL_SENDER['address'], string $fromName = CONF_MAIL_SENDER["name"]): boll
    {
        try{
            ...
            $stmt->bindValue(":from_name", this->data->subject, \PDO::PARAM_STR);
    ...
    public function sendQueue($perSecond = 5)
    {
